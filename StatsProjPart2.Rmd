...
We use a t.test for each of the three hypotheses we wish to test:
```{r}
...
1. On average, guinea pigs that were given higher doses of vitamin C ($2 mg$) through orange juice experienced greater tooth growth (M = 26.06) than guinea pigs given lower doses of $0.5 mg$ (M = 13.23). This difference was significant $t(14.668)$ = 7.817, $p$ < .01.

1. On average, guinea pigs that were given higher doses of vitamin C ($2 mg$) through ascorbic acid supplements experienced greater tooth growth (M = 26.14) than guinea pigs given lower doses of $0.5 mg$ (M = 7.98). This difference was significant $t(14.327)$ = 10.3878, $p$ < .01.

The full results of each t-test are given in the appendix.

And finally, the Gosset t-intervals are given by: 
```{r}
