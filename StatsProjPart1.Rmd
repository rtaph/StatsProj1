...
Visual inspection of the histogram reveals that the distribution of experiment means resembles the normal distribution.

The QQ plot supports this finding, with the green line representing the identity line for normal distribution. We attribute the small deviations from normality as monte carlo error (i.e. random noise from the simluation). 
