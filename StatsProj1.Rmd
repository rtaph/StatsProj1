...
cum.means <- cumsum(monte.carlo.means) / (1 : m)
empirical.mean   = cum.means[m]
g <- ggplot(data.frame(x = 1 : m, y = cum.means), aes(x = x, y = y))
g <- g + geom_line(size = 2) + labs(x = "Number of obs", y = "Cumulative mean")
g
```
